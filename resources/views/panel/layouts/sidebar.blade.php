                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                                    ...
                                    <ul class="metismenu list-unstyled" id="side-menu">
                                        ...
                                        @hasrole('superadmin')
                                            ...
                                            <li>
                                                ...
                                                <ul class="sub-menu" aria-expanded="false">
                                                    <li><a href="{{ url('panel/questionnaire/add') }}"> Create Quiz</a></li>
                                                    <li><a href="{{ url('panel/questionnaire') }}">View Quiz</a></li>
                                                    <li><a href="{{ url('panel/quiz-assigment') }}">Assign Quiz To Juror</a>
                                                    </li>
                                                    <li><a href="{{ url('panel/view/quiz-assigment') }}">View Quiz
                                                            Assigment</a></li>
                                                </ul>
                                            </li>
                                        ...
                                        @hasrole('jury')
                                            <li>
                                                ...
                                                <ul class="sub-menu" aria-expanded="false">
                                                    <li><a href="{{ url('/view-jury-cases/' . Auth::user()->id) }}">View
                                                            Cases</a></li>
                                                </ul>
                                            </li>
                                        ...
                                        @hasrole('judge')
                                            <li>
                                                ...
                                                <ul class="sub-menu" aria-expanded="false">
                                                    <li><a href="{{ url('/view-judge-cases/' . Auth::user()->id) }}">View
                                                            Cases</a></li>
                                                </ul>
                                            </li>
                                        @endrole
                    ...
                    @hasrole('judge')
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{ url('/view-judge-cases/' . Auth::user()->id) }}">View Cases</a></li>
                            </ul>
                        </li>
                    @endrole
