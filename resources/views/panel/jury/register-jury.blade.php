                                ...
                                <div class="container z-3">
                                    <div class="row">
                                        <div class="card mx-auto p-2 z-3" style="width: 600px;">
                                            <div class="card-body">
                                                <h1 class="card-title text-center py-lg-4">Jury Registration Form</h1>
                                                @include('_message')
                                                <form class="row g-3" action="" method="post">
                                                    ...
                                                    <div class="col-md-12">
                                                        <label for="inputAddress" class="form-label">Work
                                                            Address:</label>
                                                        <input type="text" class="form-control"
                                                            value="{{ old('work_add') }}" name="work_add" required>
                                                        @if ($errors->has('work_add'))
                                                            <span class="help-block text-danger">
                                                                <strong>{{ $errors->first('work_add') }}</strong>
                                                            </span>
                                                        @endif
                                                    </div>
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{ old('race') }}" name="race" required>
                                                        @if ($errors->has('race'))
                                                            <span class="help-block text-danger">
                                                    ...
                                                    <div class="col-md-12">
                                                        <label for="inputNationality"
                                                            class="form-label">Nationlity:</label>
                                                        <input type="text" class="form-control"
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{ old('district') }}" name="district" required>
