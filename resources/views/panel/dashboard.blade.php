                        ...
                        <div class="card">
                            <div class="card-body pb-0">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <h4 class="header-title mb-3" align="center" style="margin-bottom: 11.5px!important;">Statistics of Jurors Per Gender</h4>
                                ...
                                var chart = new CanvasJS.Chart("chartContainer", {
                                    ...
                                    data: [{
                                        ...
                                        indexLabel: "{label} {y}",
                                        dataPoints: [
                                            {y: male_part, label: "Male"},
                                            {y: female_part, label: "Female"}
                                        ]
                                    }]
                                });
                                chart.render();
